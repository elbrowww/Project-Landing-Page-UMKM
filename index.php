...
<button id="searchBtn" class="hidden md:flex items-center gap-2 px-4 py-2 rounded-full transition text-white" style="background: linear-gradient(135deg, #4a90e2 0%, #7c8a9e 100%);">
